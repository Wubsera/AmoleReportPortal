<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BulkPaymentBatchFileSummaryReport.aspx.cs" Inherits="AmoleReportPortal.BulkPaymentBatchFileSummaryReport" %>
    ...
    <div class="form">
        <form runat="server">
           <div class="table1" >
            ...
            <div class="table2">
                <div class="left">
                    <span style="font-size:16pt;font-weight:bold"><%=reportLink %></span>
                </div>
                <div class="right">
                    <span>
            ...
            <div class="goback">
                ...
                > <a href="PortalGetListBulkPaymentBatchFileSummaryReport.aspx?rptnumber =<%=rptn%>">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
