<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AmoleAgentActivityForFieldAgentsReport.aspx.cs" Inherits="AmoleReportPortal.AmoleAgentActivityForFieldAgentsReport" %>
    ...
    <div class="form">
        <form runat="server">
            ...
            <div class="goback">
                ...
                ><a href="PortalGetListAmoleAgentActivityForFieldAgentsReport.aspx">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
