<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContentSalesDetailReport.aspx.cs" Inherits="AmoleReportPortal.ContentSalesDetailReport" %>
    ...
    <div class="form">
        <form runat="server">
            ...
            <div class="goback">
                ...
                > <a href="PortalGetListContentSalesDetailReport.aspx">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
