<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplyOrder.aspx.cs" Inherits="AmoleReportPortal.SupplyOrder" %>
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="auto-style1" style="mso-border-alt: solid windowtext .0pt; mso-yfti-tbllook: 1184; mso-padding-alt: 0in 5.4pt 0in 5.4pt; height: 50px; width: 100%">
                ...
                <tr style="mso-yfti-irow: 0; mso-yfti-firstrow: yes; mso-yfti-lastrow: yes">
                    ...
                    <td style="border: 0; background: #FDDB00; text-align: right; font-weight: bold">
                        ...
                        <img class="person" src="Images/person.png" style="margin-right: 5px; height: 75px; margin-left: 0px; margin-bottom: -4px; width: 80px" />
...
&nbsp;
			...
			>
			</span> <a href='javascript:history.go(-1)'>Go Back to Date Filter</a>
              <br />
