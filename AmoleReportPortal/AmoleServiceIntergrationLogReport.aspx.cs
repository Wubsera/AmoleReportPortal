...
{
    public partial class AmoleServiceIntegrationLogReport : System.Web.UI.Page
    {
        ...
        {
            rptn = PortalGetListServiceIntegration.rptn;
            ...
            if (!IsPostBack)
            {
                ...
                //reportLink = PortalGetListServiceIntegration.reportLink;
                //From = PortalGetListServiceIntegration.From;
                //To = PortalGetListServiceIntegration.To;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    crystalReport.Load(Server.MapPath("AmoleServiceIntegrationLogReport1.rpt"));
