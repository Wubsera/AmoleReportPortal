<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BulkPaymentBatchFileDetailReport.aspx.cs" Inherits="AmoleReportPortal.BulkPaymentBatchFileDetailReport" %>
...
<body>
    <div class="form">
        <form runat="server">
            ...
            <strong>&gt; </strong>
                <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Go Back to Filter</asp:LinkButton>
