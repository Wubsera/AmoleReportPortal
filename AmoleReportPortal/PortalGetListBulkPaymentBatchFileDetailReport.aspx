<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PortalGetListBulkPaymentBatchFileDetailReport.aspx.cs" Inherits="AmoleReportPortal.PortalGetListBulkPaymentBatchFileDetailReport" %>
    ...
    <div class="form">
        <form runat="server">
            ...
            <div class="menu">
                ...
                <asp:TextBox ID="SearchValue" runat="server" CssClass="search" Placeholder="Batch ID" >
