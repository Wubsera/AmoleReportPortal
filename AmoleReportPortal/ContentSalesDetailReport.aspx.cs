...
{
    public partial class ContentSalesDetailReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                reportLink = PortalGetListContentSalesDetailReport.reportLink;
                From = PortalGetListContentSalesDetailReport.From;
                To = PortalGetListContentSalesDetailReport.To;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    crystalReport.Load(Server.MapPath("ContentSalesDetailReport1.rpt"));
