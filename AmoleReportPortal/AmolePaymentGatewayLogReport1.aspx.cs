...
{
    public partial class AmolePaymentGatewayLogReport1 : System.Web.UI.Page
    {
        ...
        {
            rptn = PortalGetListPaymentGateway.rptn;
            ...
            if (!IsPostBack)
            {
                rptnumber = PortalGetListPaymentGateway.rptnumber;
                ...
                //reportLink = PortalGetListPaymentGateway.reportLink;
                //From = PortalGetListPaymentGateway.From;
                //To = PortalGetListPaymentGateway.To;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    crystalReport.Load(Server.MapPath("AmolePaymentGatewayLogReport.rpt"));
