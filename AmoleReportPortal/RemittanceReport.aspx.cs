...
namespace AmoleReportPortal
{
    public partial class RemittanceReport : System.Web.UI.Page
    {
        ...
        {
            rptn = PortalGetListRemittanceReport.rptn;
            ...
            if (!IsPostBack)
            {
                rptnumber = PortalGetListRemittanceReport.rptnumber;
                ...
                //reportLink = PortalGetListRemittanceReport.reportLink;
                //From = PortalGetListRemittanceReport.From;
                //To = PortalGetListRemittanceReport.To;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    crystalReport.Load(Server.MapPath("RemittanceReport1.rpt"));
        ...
        protected void LinkButton1_Click1(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect(ViewState["PortalGetList.aspx"].ToString());
                //Redirect to 
