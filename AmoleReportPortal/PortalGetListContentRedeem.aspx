<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PortalGetListContentRedeem.aspx.cs" Inherits="AmoleReportPortal.PortalGetListContentRedeem" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="Css/PortalGetListConentRedeem.css" />
</head>
<body>
    <div class="form">
        <form runat="server">
           <div class="table1" >
            ...
            <div class="menu" style="width:900px">
                ...
                <section>
                    <asp:Label ID="Label2" runat="server" CssClass="merchant2" Text="DigiSales Event or Category:"></asp:Label>
                    <asp:DropDownList ID="DropDownList1" CssClass="ddselctbranch2" runat="server" AutoPostBack="true"
                        OnDataBound="DropDownListSelectEvent_DataBound" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                    </asp:DropDownList>
                </section>
                <section>
