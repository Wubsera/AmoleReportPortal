...
{
    public partial class RemittanceCheckStatus : System.Web.UI.Page
    {
        ...
        public static string RecievedAs;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                string insertStoredProcName = "sp_Portal_118_Remittance_Check_Status";
                try
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(insertStoredProcName, conn))
                    {
                        ...
                        using (SqlDataReader sqlReader = cmd.ExecuteReader())
                        {
                            ...
                            {
                                Status = GridView2.Rows[i].Cells[7].Text;
                                AMTN2 = GridView2.Rows[i].Cells[2].Text;
                                ReceivedDate = GridView2.Rows[i].Cells[10].Text;
                                MerchantName = GridView2.Rows[i].Cells[21].Text;
                                SourceControlNumber = GridView2.Rows[i].Cells[22].Text;
                                AmountToCustomer = GridView2.Rows[i].Cells[12].Text;
                                ExchangeRate = GridView2.Rows[i].Cells[11].Text;
                                RefNo = GridView2.Rows[i].Cells[8].Text;
                                ConfNo = GridView2.Rows[i].Cells[9].Text;
                                SenderName = GridView2.Rows[i].Cells[23].Text;
                                SenderCity = GridView2.Rows[i].Cells[28].Text;
                                SenderCountry = GridView2.Rows[i].Cells[29].Text;
                                SenderNationality = GridView2.Rows[i].Cells[31].Text;
                                SenderResidency = GridView2.Rows[i].Cells[30].Text;
                                SenderBirthDate = GridView2.Rows[i].Cells[27].Text;
                                SenderMobile = GridView2.Rows[i].Cells[24].Text;
                                ...
                                RecipientResidency = GridView2.Rows[i].Cells[32].Text;
                                RecipientEmail = GridView2.Rows[i].Cells[34].Text;
                                RecievedAs = GridView2.Rows[i].Cells[3].Text;
                                AllowCancel = GridView2.Rows[i].Cells[4].Text;
                                AllowPrint = GridView2.Rows[i].Cells[5].Text;
                        ...
                        using (SqlDataReader sqlReader = cmd.ExecuteReader())
                        {
                            ...
                            while (sqlReader.Read())
                            {
                                ...
                                if (AllowPrint != "Y")
                                {
                                    ...
                                    Button2.Attributes["style"] = "cursor:default";
                                ...
                                else
                                {
                                    ...
                                    Button2.BackColor = ColorTranslator.FromHtml("#4169E1");
                                ...
                                if (AllowCancel != "Y")
                                {
                                    ...
                                    Button4.Attributes["style"] = "cursor:default";
                                }
                                else
                                {
        ...
        {
            Response.Redirect("PrintReceiptCheckStatus.aspx");
        }
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            {
                string connectionString = ConfigurationManager.ConnectionStrings["RemittanceCashOutConnection"].ConnectionString;
                string insertStoredProcName = "sp_Portal_118_Remittance_Cancel";
                string columns;
                try
                {
                    using (SqlConnection conn = new SqlConnection(connectionString))
                    using (SqlCommand cmd = new SqlCommand(insertStoredProcName, conn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@AMTN", AMTN2);
