<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DSTVPaymentsReport.aspx.cs" Inherits="AmoleReportPortal.DSTVPaymentsReport" %>
    ...
    <div class="form">
        <form runat="server">
            ...
            <div class="goback">
                ...
                ><a href="PortalGetListDSTVPaymentsReport.aspx?rptnumber =<%=rptn %>">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
