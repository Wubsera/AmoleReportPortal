<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FieldAgentsActiveInactiveReports.aspx.cs" Inherits="AmoleReportPortal.FieldAgentsActiveInactiveReports" %>
    ...
    <div class="form">
        <form runat="server">
            ...
            <div class="goback">
                ...
                ><a href="PortalGetListFieldAgentsActiveInactiveReport.aspx">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
