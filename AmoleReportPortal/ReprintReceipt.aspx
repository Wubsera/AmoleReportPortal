<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReprintReceipt.aspx.cs" Inherits="AmoleReportPortal.ReprintReceipt" %>
    ...
    <form id="form1" runat="server">
        <div class="print-receipt">
            ...
            <section style="margin-top:10px;">
                    How to Receive: <span style="font-weight:bold"> <%=HoToReceive %></span>
                </section>
            <div class="footer">
                <div class="sender">
