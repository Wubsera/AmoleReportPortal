<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemittanceSuspenseAccountReport.aspx.cs" Inherits="AmoleReportPortal.RemittanceSuspenseAccountReport" %>
    ...
    <div class="form">
        <form runat="server">
            ...
            <div class="goback">
                ...
                > <a href="PortalGetListRemittanceSuspenseAccountReport.aspx?rptnumber =<%=rptn%>">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
