...
{
    public partial class PortalGetListAmoleAgentActivityForFieldAgentsReport : System.Web.UI.Page
    {
        ...
        protected void Generate_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (MerchantID != "")
            {
                Response.Redirect("AmoleAgentActivityForFieldAgentsReport.aspx");
