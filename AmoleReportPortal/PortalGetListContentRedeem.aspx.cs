...
{
    public partial class PortalGetListContentRedeem : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                commandReport.Parameters.AddWithValue("@ListType", 3);
                ...
                SqlConnection connectionReport1 = new SqlConnection(ConfigurationManager.ConnectionStrings["FettanReportPortalConnection"].ToString());
                SqlCommand commandReport1 = new SqlCommand("sp_Portal_GetList", connectionReport);
                commandReport1.CommandType = CommandType.StoredProcedure;
                commandReport1.Parameters.AddWithValue("@ListType", 8);
                commandReport1.Parameters.AddWithValue("@LoginID", LoginID);
                commandReport1.Connection = connectionReport1;

                try
                {
                    connectionReport1.Open();
                    DropDownList1.DataSource = commandReport1.ExecuteReader();
        ...
        protected void DropDownListSelectBranch_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            EventID = DropDownList1.SelectedValue;
            ...
            commandReport.Parameters.AddWithValue("@Integer1", EventID);
            commandReport.Parameters.AddWithValue("@Integer2", MerchantID);
        }
        ...
        protected void DropDownListSelectEvent_DataBound(object sender, EventArgs e)
        {
            MerchantID = DropDownListSelectBranch.SelectedValue;
            EventID = DropDownList1.SelectedValue;
            SqlConnection connectionReport = new SqlConnection(ConfigurationManager.ConnectionStrings["FettanReportPortalConnection"].ToString());
