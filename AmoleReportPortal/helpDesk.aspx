<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="helpDesk.aspx.cs" Inherits="AmoleReportPortal.helpDesk" %>
    ...
    <div class="form">
        <form runat="server">
            <div class="table1" style="margin-top:-20px">
                ...
                <div class="right">
                 <img src="Images/AmoleLogo.jpg" />
                        <h1 style="text-align:right;font-size:15.5pt;font-weight:bold;padding-top:15px"><%=FullName %></h1>
            ...
            <div class="table2">
                ...
                <div class="right">
                    <span>
                    <a href="helpDesk.aspx" style="color:white;text-align:right">Technical Support Help Desk</a>
                    </span>
                </div>
            </div>
