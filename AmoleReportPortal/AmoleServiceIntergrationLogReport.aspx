<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AmoleServiceIntergrationLogReport.aspx.cs" Inherits="AmoleReportPortal.AmoleServiceIntegrationLogReport" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="Css/PortalReportServiceIntegration.css" />
        ...
        <form runat="server">
          <div class="table1" >
            ...
            <div class="goback">
                ...
                ><a href="PortalGetListServiceIntegration.aspx?rptnumber =<%=rptn %>">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
                    <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" Style="overflow-x: scroll" ReuseParameterValuesOnRefresh="True" ToolPanelView="None" HasRefreshButton="True" />
                </section>
