<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CanalPlusPayments.aspx.cs" Inherits="AmoleReportPortal.CanalPlusPayments" %>
    ...
    <div class="form">
        <form runat="server">
            ...
            <div class="goback">
                ...
                ><a href="PortalGetListCanalPlusTransactionLogReport.aspx?rptnumber =<%=rptn %>">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
