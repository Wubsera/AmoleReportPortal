<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PortalReportAvailable.aspx.cs" Inherits="AmoleReportPortal.PortalReportAvailable" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="Css/PortalReportavailable.css" />
...
<body>
    <div class="form">
        <form runat="server">
            ...
            <div class="table2">
                <div class="left">
                    <span>Reports Available to you</span>
                </div>
                <div class="right">
                    <span>
            ...
            <div class="menu">
                ...
                <section>
                    <asp:GridView ID="GridView1" runat="server" AllowSorting="true" AutoGenerateColumns="False" Style=" margin-top: 5px; font-family: Calibri; font-size: 12pt; font-weight: bold" OnRowDataBound="OnRowDataBound" DataSourceID="shoa" GridLines="None" CellPadding="1" Width="343px" ShowHeader="False" Height="73px">
                        <Columns>
                    ...
                    <asp:GridView ID="GridView2" runat="server" Width="322px" Style="font-family: Calibri"></asp:GridView>
                </section>
                <section>
                    <asp:GridView ID="GridView3" runat="server" Width="322px" Style="font-family: Calibri"></asp:GridView>
                </section>
                <section>
                    <asp:SqlDataSource ID="shoa" runat="server" ConnectionString="<%$ ConnectionStrings:FettanReportPortalConnection %>" SelectCommand="sp_Portal_Reports_Available" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                </section>
    ...
    <div class="footer">
        ...
        <span style="color:blue;font-size:10pt">Powered by Amole
        </span>
    </div>
</body>
        <script>
