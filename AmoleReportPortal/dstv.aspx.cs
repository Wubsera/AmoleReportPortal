...
{
    public partial class dstv : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    crystalReport.Load(Server.MapPath("Dstv.rpt"));
                    crystalReport.SetDatabaseLogon("ReportPortal", "P@ssw0rd", "196.188.93.52", "FettanSecurity");
