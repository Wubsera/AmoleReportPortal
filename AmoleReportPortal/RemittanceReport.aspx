<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemittanceReport.aspx.cs" Inherits="AmoleReportPortal.RemittanceReport" %>
    ...
    <div class="form">
        <form runat="server">
            ...
            <div class="goback">
                ...
                > <a href="PortalGetListRemittanceReport.aspx">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
