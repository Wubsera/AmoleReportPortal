<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MposMerchantActivity.aspx.cs" Inherits="AmoleReportPortal.MposMerchantActivity" %>
        ...
        <form runat="server">
          <div class="table1" >
            ...
            <div class="goback">
                ...
                > <a href="PortalGetListMPOSActivity.aspx?rptnumber =<%=rptn%>">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
