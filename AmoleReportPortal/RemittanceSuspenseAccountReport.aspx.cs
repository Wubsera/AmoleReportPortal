...
{
    public partial class RemittanceSuspenseAccountReport : System.Web.UI.Page
    {
        ...
        {
            rptn = PortalGetListRemittanceSuspenseAccountReport.rptn;
            ...
            if (!IsPostBack)
            {
                rptnumber = PortalGetListRemittanceSuspenseAccountReport.rptnumber;
                ...
                //reportLink = PortalGetListRemittanceSuspenseAccountReport.reportLink;
                //From = PortalGetListRemittanceSuspenseAccountReport.From;
                //To = PortalGetListRemittanceSuspenseAccountReport.To;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    crystalReport.Load(Server.MapPath("RemittanceSuspenseAccountReport1.rpt"));
