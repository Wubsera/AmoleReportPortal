...
{
    public partial class ContentRedeem : System.Web.UI.Page
    {
        ...
        {
            rptn = PortalGetListContentRedeem.rptn;
            ...
            reportLink = PortalGetListContentRedeem.reportLink;
            From = PortalGetListContentRedeem.From;
            To = PortalGetListContentRedeem.To;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    crystalReport.Load(Server.MapPath("ContentRedeemReport.rpt"));
                    ...
                    cmd.Parameters.AddWithValue("@Integer1", EventID);
                    cmd.Parameters.AddWithValue("@Integer2", MerchantID);
