<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PortalGetListFieldAgentActiveInactiveReport1.aspx.cs" Inherits="AmoleReportPortal.PortalGetListFieldAgentActiveInactiveReport" %>
...
<%--              <input id="NoDays" runat="server" autocomplete="off" style="padding-top: 3px;text-align:center; padding-bottom: 3px; background-color: #FFFFE1; font-size: 12pt;width:60px;font-weight:bold;" type="number" />--%>
                    Active in the last <asp:TextBox ID="NoDays" runat="server" Text="30" style="padding-top: 3px;text-align:center; padding-bottom: 3px; background-color: #FFFFE1; font-size: 12pt;width:60px;font-weight:bold;" type="number" ></asp:TextBox> Days
          </span>
                <asp:ImageButton ID="ImageButton1" CssClass="image" src="Images/run.png" runat="server"
                    ToolTip="GENERATE REPORT" OnClick="Generate_Click" style="margin-bottom:-20px" />
                 ...
                 <%--<asp:TextBox ID="txtFrom" CssClass="txtFrom" AutoCompleteType="Disabled" runat="server"
                        ...
                        OnTextChanged="txtFrom_TextChanged" style="margin-top: 0px"></asp:TextBox>--%><%-- <asp:TextBox ID="txtTo" CssClass="txtTo" AutoCompleteType="Disabled" runat="server"
                ...
                <div class="calendar">
                    ...
                    <section>
                        <asp:Calendar ID="Calendar2" style="display:none" runat="server" Font-Underline="False"
