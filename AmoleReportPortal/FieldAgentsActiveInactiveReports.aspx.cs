...
{
    public partial class FieldAgentsActiveInactiveReports : System.Web.UI.Page
    {
        ...
        {
            //rptn = PortalGetListKidameMartActiveAgentsReport.rptn;
            ...
            if (!IsPostBack)
            {
               ...
               // reportLink = PortalGetListKidameMartActiveAgentsReport.reportLink;
               // From = PortalGetListKidameMartActiveAgentsReport.From;
               // To = PortalGetListKidameMartActiveAgentsReport.To;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            //if (Session["NumberOfDays"] != null)
            //{
            //    NumberOfDays = Session["NumberOfDays"].ToString();
            //}
            if ((HttpContext.Current.Request.UrlReferrer == null))
            {
                Response.Redirect("Login.aspx");
            ...
            if (!IsPostBack)
            {
                try
                {
                    crystalReport.Load(Server.MapPath("FieldAgentsActiveInactiveReport1.rpt"));
                   ...
                   // cmd.Parameters.AddWithValue("@Integer2", NumberOfDays);
