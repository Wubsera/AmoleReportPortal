<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="PortalGetListFieldAgentSalesReport.aspx.cs" Inherits="AmoleReportPortal.PortalGetListFieldAgentSalesReport" %>
    ...
    <div class="form">
        <form runat="server">
           ...
           <div class="goback">
            ...
            <div class="menu">
                <section>
                    <asp:Label ID="Label1" runat="server" CssClass="merchant" Text="Merchant:" Width="70"></asp:Label>
                    <asp:DropDownList ID="MerchantDropdown" CssClass="ddselctbranch"
                        runat="server" AutoPostBack="true" 
                        OnSelectedIndexChanged="MerchantDropdown_SelectedIndexChanged" 
                        OnDataBound="MerchantDropdown_SelectedIndexChanged">
                    </asp:DropDownList>
                </section>
                <section>
                    <asp:Label ID="Label2" runat="server" Text="Region: " CssClass="merchant" Width="70"></asp:Label>                   
                     <asp:DropDownList ID="RegionDropdown" CssClass="ddselctbranch"
                        runat="server" AutoPostBack="true" 
                        OnSelectedIndexChanged="RegionDropdown_SelectedIndexChanged" OnDataBound="RegionDropdown_SelectedIndexChanged">
                    </asp:DropDownList>
                </section>
                <section>
                    <asp:Label ID="Label3" runat="server" Text="Zone: " CssClass="merchant" Width="70"></asp:Label>                   
                     <asp:DropDownList ID="ZoneDropdown" CssClass="ddselctbranch"
                        runat="server" AutoPostBack="true" 
                        OnSelectedIndexChanged="ZoneDropdown_SelectedIndexChanged" OnDataBound="ZoneDropdown_SelectedIndexChanged"> 
                    </asp:DropDownList>
                </section>
                  <section>
                    <asp:Label ID="Label5" runat="server" Text="Woreda: " CssClass="merchant" Width="70"></asp:Label>                   
                     <asp:DropDownList ID="WoredaDropdown" CssClass="ddselctbranch"
                        runat="server" AutoPostBack="true" OnSelectedIndexChanged="WoredaDropdown_SelectedIndexChanged">
                    </asp:DropDownList>
                </section>
                <section>
                    <asp:Label ID="Label4" runat="server" Text="City: " CssClass="merchant" Width="70"></asp:Label>                   
                     <asp:DropDownList ID="CityDropdown" CssClass="ddselctbranch"
                        runat="server" AutoPostBack="true" 
                        OnSelectedIndexChanged="CityDropdown_SelectedIndexChanged" OnDataBound="CityDropdown_SelectedIndexChanged">
                    </asp:DropDownList>
                </section>
                <section>
