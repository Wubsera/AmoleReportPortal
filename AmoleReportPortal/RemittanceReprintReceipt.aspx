<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemittanceReprintReceipt.aspx.cs" Inherits="AmoleReportPortal.RemittanceReprintReceipt" %>
           ...
           <div class="table1" >
            ...
            <asp:Panel ID="Panel2" runat="server">
                <asp:Panel ID="Panel3" runat="server">
                    <div class="Receipt">
                        <h3><u><b>International Money Transfer Receipt</b></u></h3>
                    ...
                    <div class="sender-info">
                     <section>
                      Setllment Status: <span style="font-weight:bold"><%=HowToRecieve%></span>
                    </section>
                        <div class="sender">
