...
{
    public partial class PortalGetListServiceIntegration : System.Web.UI.Page
    {
        ...
        protected void Generate_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                //ClientScript.RegisterClientScriptBlock(this.GetType(), "s", "window.alert('Merchant not assigned, please contact amole support');window.location='PortalGetListServiceIntegration.aspx'", true);
            }
        }
