...
{
    public partial class MerchantAccTransactionsReport : System.Web.UI.Page
    {
        ...
        {
            rptn = PortalGetListMerchantAccountTransaction.rptn;
            ...
            if (!IsPostBack)
            {
                rptnumber = PortalGetListMerchantAccountTransaction.rptnumber;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    crystalReport.Load(Server.MapPath("MerchantAccTransactionsReport1.rpt"));
