...
{
    public partial class AmoleAgentActivityForFieldAgentsReport : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    crystalReport.Load(Server.MapPath("AmoleAgentActivityForFieldAgentsReport1.rpt"));
