<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AmolePaymentGatewayLogReport1.aspx.cs" Inherits="AmoleReportPortal.AmolePaymentGatewayLogReport1" %>
        ...
        <form runat="server">
           <div class="table1" >
            ...
            <div class="goback">
                ...
                ><a href="PortalGetListPaymentGateway.aspx?rptnumber =<%=rptn%> ">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
                    <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" Style="overflow-x: scroll" ToolPanelView="None" ReuseParameterValuesOnRefresh="True" HasRefreshButton="True" />
                </section>
