...
{
    public partial class ContentSales1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            reportLink = PortalGetListc.reportLink;
            From = PortalGetListc.From;
            To = PortalGetListc.To;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    crystalReport.Load(Server.MapPath("ContentSales.rpt"));
