<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FieldAgentSalesReport.aspx.cs" Inherits="AmoleReportPortal.FieldAgentSalesReport" %>
    ...
    <div class="form">
        <form runat="server">
            ...
            <div class="goback">
                ...
                ><a href="PortalGetListFieldAgentSalesReport.aspx">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
