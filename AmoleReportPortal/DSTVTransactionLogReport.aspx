<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DSTVTransactionLogReport.aspx.cs" Inherits="AmoleReportPortal.DSTVTransactionLogReport1" %>
    ...
    <div class="form">
        <form runat="server">
            ...
            <div class="goback">
                ...
                ><a href="PortalGetListDSTVTransactionLogReport.aspx?rptnumber =<%=rptn %>">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
