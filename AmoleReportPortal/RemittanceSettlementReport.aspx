<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemittanceSettlementReport.aspx.cs" Inherits="AmoleReportPortal.RemittanceSettlementReport" %>
    ...
    <div class="form">
        <form runat="server">
            ...
            <div class="goback">
                ...
                > <a href="PortalGetListRemittanceSettlementReport.aspx?rptnumber =<%=rptn%>">Go Back to Date Filter</a>
            </div>
            <div class="menu">
                <section>
